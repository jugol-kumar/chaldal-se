<template>
    <CLayout>
        ...
        <div class="row mt-5">
            <div class="card col-md-6 shadow-none" v-for="item in props.addresses" v-if="props.addresses">
                <div class="card-body address-box border-secondary">
...
<!--                <div class="d-flex mt-1 align-items-start gap-1 flex-column">
                ...
                <button type="reset" class="btn float-end btn-sm  bg-danger mt-1 ms-1 text-white" data-bs-dismiss="modal" aria-label="Close">
                    close
                </button>
                <button type="submit" class="btn float-end btn-sm btn-default border-1 border-primary text-primary mt-1">
