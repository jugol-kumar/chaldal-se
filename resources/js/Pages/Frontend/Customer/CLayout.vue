...
import Header from "../Shared/TopHeader.vue";
import {ref} from "vue";
...
<template>
    <Layout>
        <div class="container-lg pb-5 mb-2 mb-md-4" style="min-height: 100vh">
            <div class="row">
                <!-- Sidebar-->
                <aside class="col-lg-3 pt-4 pt-lg-0 d-lg-block d-none">
                    <div class="bg-white rounded-3 pt-1 mb-5 mb-lg-0 h-100" style="border:1px solid #ebebeb">
                        ...
                        <div class="d-lg-block collapse" id="account-menu">
                            <div class="bg-secondary px-1 py-1">
