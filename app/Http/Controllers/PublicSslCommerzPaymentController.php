    ...
    public function success(Request $request)
    {
        ...
        if(isset($request->value_c)){
            if($request->value_c == 'cart_payment'){
                ...
                return $checkoutController->checkout_done($request->value_b, $payment, $amount, 'SSLCommerz');
            }
            elseif($request->value_c == 'partial'){
              $partialController = new PartialPaymentController;
              return $partialController->partial_payment_done($request->value_b, $payment, $amount, 'SSLCommerz');
            }
